...
-- Calls table without FK to profiles
...
-- RLS policies for calls (drop then create)
...
-- Transcripts table without FK to profiles
...
drop policy if exists "Users can insert their transcripts" on public.transcripts;
drop policy if exists "Users can update their transcripts" on public.transcripts;
drop policy if exists "Users can delete their transcripts" on public.transcripts;
...
-- Alerts table without FK to profiles
...
drop policy if exists "Users can insert their alerts" on public.alerts;
